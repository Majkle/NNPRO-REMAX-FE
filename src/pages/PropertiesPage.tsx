...
const PropertiesPage: React.FC = () => {
  ...
  // Fetch properties from backend based on page and filters
  useEffect(() => {
    let cancelled = false;
    ...
    const fetchProperties = async () => {
      try {
        ...
        const params: PropertySearchParams = {
          ...
          contractType: transactionFilter !== 'all' ? (transactionFilter as TransactionType) : undefined,
        };

        const paginatedResponse = await propertyService.searchProperties(params);

        if (!cancelled) {
          // Replace properties instead of concatenating to avoid duplication
